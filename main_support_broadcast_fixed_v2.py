...
def process_message_update(data):
    ...
    if uid not in ADMIN_IDS:
        ...
        # Relay EVERY user message to admins, including /start, /help, random
        # commands, media, files, stickers, contacts, locations, etc.
        # Admins receive the same user-details header plus a copy of the message.
