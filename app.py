...
def show_admin_home(chat_id, mid=None):
    ...
    kb=[
        ...
        [_settings_button("⚙️ SETTINGS","m_sett","bold"), _settings_button("📊 ANALYTICS","m_stats","serif")],
        [_settings_button("🧹 MESSAGE CLEANUP","set_grp_cleanup","mono"), _settings_button("🛠 SYSTEM","set_system","serif")]
    ]
